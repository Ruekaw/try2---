...
- method=daws_save, save=True, w_early=0.4, w_late=0.0, n_cut=6

## audience（观众优先：最小化 popularity_vulnerability）
- method=daws_direct, save=False, w_early=0.8, w_late=0.4, n_cut=4

## balanced（折衷：min-max 归一化后加权求和，tech 权重更高）
- method=daws_save, save=True, w_early=0.4, w_late=0.4, n_cut=4
